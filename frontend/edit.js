...
function handleRemove() {
    ...
    xhr.onload = function (e) {
        displayResultsRemove(xhr.responseText);
    }
...
function handleReset() {
    ...
    xhr.onload = function (e) {
        displayResultsReset(xhr.responseText);
    }
...
function displayResultsAdd(responseText) {
    ...
    var labelText = document.createTextNode(response);
    label.appendChild(labelText);
    var container = document.getElementById("results-container");
    container.appendChild(label);
}

function displayResultsRemove(responseText) {
    response = JSON.parse(responseText);
    var label = document.createElement("label");
    label.setAttribute("id", "results-label");
    var labelText = document.createTextNode(response);
...
function displayResultsReset(responseText) {
    response = JSON.parse(responseText);
    var label = document.createElement("label");
    label.setAttribute("id", "results-label");
    var labelText = document.createTextNode(response);
